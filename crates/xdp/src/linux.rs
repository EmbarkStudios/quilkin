...
impl EbpfProgram {
    ...
    fn load_inner(
        ...
        Ok(Self {
            bpf,
            external_port: xdp::packet::net_types::NetworkU16(u16::from_be_bytes(external_port_no)),
            qcmp_port: xdp::packet::net_types::NetworkU16(u16::from_be_bytes(qcmp_port_no)),
        })
    }
