...
cfg_select! {
    all(feature = "jemalloc", not(target_env = "msvc")) => {
        ...
        pub fn spawn_heap_stats_updates(_period: std::time::Duration, _srx: quilkin_graceful::ChildToken) {
    ...
    feature = "heap-stats" =>  {
        ...
        pub fn spawn_heap_stats_updates(period: std::time::Duration, mut srx: quilkin_graceful::ChildToken) {
